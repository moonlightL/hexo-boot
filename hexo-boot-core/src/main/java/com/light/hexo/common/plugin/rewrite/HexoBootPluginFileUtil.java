...
/**
 * @Author MoonlightL
 * @ClassName: HexoBootPluginFileUtil
 * @ProjectName hexo-boot
 * @Description: 重写工具类,处理卸载插件资源依然被占用问题
 * @DateTime 2022/4/23, 0023 23:37
 */
public class HexoBootPluginFileUtil {

    private HexoBootPluginFileUtil() {}
