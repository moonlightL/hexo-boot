...
public class IndexAlbumController extends CommonController {
     ...
     * @return
     */
    @GetMapping(value = {"albumDetail/{albumId}/", "albumDetail/{albumId}/{pageNum}"})
    public String albumsDetail(@PathVariable Integer albumId, @PathVariable(value="pageNum", required = false) Integer pageNum, Map<String, Object> resultMap) {
